...
<html lang="es">
    ...
    <head>
        ...
        <title>Clientes Bio-Tienda</title>
                    ...
                    <div class="container-fluid px-4">
                        <div class="container px-4">
                            <div class="card mt-4">
                                ...
                                <div class="card-body">
                                    <form action="ClienteController?menucliente=Cliente" method="POST">
                                        <div class="row">
                                            <div class="form-group col-2">
                                                <label class="mb-2">DNI:</label>
                                                <input type="text" value="${cliente.getDni()}" name="txtDni" class="form-control" maxlength="8">
                                            </div>
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="form-group col-6">
                                                ...
                                                <input type="tex" value="${cliente.getEstado()}" name="txtEstado" class="form-control" maxlength="1">
                                            </div>
                                            <div class="row mt-4 ">
                                                ...
                                                <div class="col-6 d-grid gap-2 col-6mx-auto">
                                                    <button type="submit" name="accion" value="Actualizar" class ="btn btn-success mb-4 ">
                                                        <i class="fas fa-plus-square"></i> Actualizar Cliente
                                                    </button> 
                                                </div>
                                            </div>
                                    </form>
                            ...
                            <div class="row text-center mt-5">
                                <form action="ClienteController?menucliente=Cliente" method="POST">
                                    <button type="submit" name="accion" value="Listar" class ="btn btn-success mb-4 ">
                                        <i class="fas fa-plus-square"></i> Listar Clientes
                                    </button> 
                                </form>
                            </div>
                                ...
                                <tbody>
                                    <c:forEach var="cli" items="${clientes}">
                                        <tr>
                                            ...
                                            <td>${cli.getEstado()}</td>
                                            <td><a type="submit" class ="btn btn-warning" href="ClienteController?menucliente=Cliente&accion=Editar&id=${cli.getId()}">
                                                    <i class="fas fa-edit"></i> Editar
                                                </a></td>
                                            <td><a type="submit" class ="btn btn-danger" href="ClienteController?menucliente=Cliente&accion=Eliminar&id=${cli.getId()}">
