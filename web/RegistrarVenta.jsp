            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container px-4">
                        <form action="VentaController?menuventa=NuevaVenta" method="POST">
                            <div class="card mt-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group d-flex">
                                        ...
                                        <div class="col-sm-2"> 
                                            <button type="submit" name="accion" value="BuscarCliente" class ="btn btn-success">
                                                <i class="fas fa-plus-square"></i> Buscar
                                            </button>
                                        </div>
                                        <div class="col-sm-6" >
                                            <input type="text" name="nombrescliente" value="${c.getNombres()}" class="form-control" placeholder="Nombre del cliente">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group d-flex">
                                        ...
                                        <div class="col-sm-2"> 
                                            <button type="submit" name="accion" value="BuscarProducto" class ="btn btn-success">
                                                <i class="fas fa-plus-square"></i> Buscar
                                            </button>
                                        </div>
                                        <div class="col-sm-6" >
                                            <input type="text" name="nombreproducto" value="${producto.getNombres()}" class="form-control" placeholder="Nombre del producto">
                                        </div>
                                    </div>
                                        ...
                                        <tbody>
                                            <c:forEach var="list" items="${lista}">
                                                <tr>
                                                    ...
                                                    <td><a type="submit" class ="btn btn-warning" href="ProductoController?menuproducto=Producto&accion=Editar&id=${pro.getId()}">
                                                            <i class="fas fa-edit"></i> Editar
                                                        </a></td>
                                                    <td><a type="submit" class ="btn btn-danger" href="ProductoController?menuproducto=Producto&accion=Eliminar&id=${pro.getId()}">
                                    ...
                                    <div class="card-footer">
                                        <div class="row mt-4 ">
                                            <div class="col-4 d-grid gap-2 mx-auto">
                                                <button type="submit" name="accion" value="GenerarVenta"  class ="btn btn-success mb-4 ">
                                                    <i class="fas fa-plus-square"></i> Generar Venta
                                                </button> 
                                            </div>
                                            <div class="col-4 d-grid gap-2  mx-auto">
                                                <button type="submit" name="accion" value="Cancelar" class ="btn btn-danger mb-4 ">
                                                    <i class="fas fa-plus-square"></i> Cancelar
                                                </button> 
                                            </div>
