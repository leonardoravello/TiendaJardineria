...
<html lang="es">
    ...
    <head>
        ...
        <title>Productos Bio-Tienda</title>
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
                                ...
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="ProductoController?menuproducto=Producto&accion=default">Ver Productos</a>
                                </nav>
                            </div>
                            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
                ...
                <main>
                    <div class="container px-4">
                        <div class="card mt-4">
                            ...
                            <div class="card-body">
                                <form action="ProductoController?menuproducto=Producto" method="POST">
                                    <div class="row">
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <input type="text" value="${producto.getEstado()}" name="txtEstado" class="form-control" maxlength="1">
                                        </div>
                                    </div>
                                    <div class="row mt-4 ">
                                        ...
                                        <div class="col-6 d-grid gap-2 col-6mx-auto">
                                            <button type="submit" name="accion" value="Actualizar" class ="btn btn-success mb-4 ">
                                                <i class="fas fa-plus-square"></i> Actualizar Producto
                                            </button> 
                                        </div>
                                    </div>
                                </form>
                        ...
                        <div class="row text-center mt-5">
                            <form action="ProductoController?menuproducto=Producto" method="POST">
                                <button type="submit" name="accion" value="Listar" class ="btn btn-success mb-4 ">
                                    <i class="fas fa-plus-square"></i> Listar Productos
                                </button> 
                            </form>
                        </div>
